...
public class ComprarProdutos {
    ...
    public ComprarProdutos(RegistroVendedor registroVendedor, RegistroCliente registroCliente) {
        this.registroVendedor =registroVendedor;
        this.registroCliente = registroCliente;
    }

    public void escolherProduto(Cliente cliente) {
    double total = 0.0;
        ...
        switch (opcao) {
            case 1:
                ...
                if (codigoSabonete.equals(71)) {
                    ...
                    cliente.setCompra(sabonete2,quantidadeSabonete);
                    ...
                    cliente.setCompra(sabonete3,quantidadeSabonete);
                } else {
            ...
            case 2:
                ...
                if (codigoCreme.equals(81)) {
                    ...
                    cliente.setCompra(creme1,quantidadeCreme);
                    ...
                    cliente.setCompra(creme2,quantidadeCreme);
                    ...
                    cliente.setCompra(creme3,quantidadeCreme);
            ...
            case 3:
               lista.listaPerfume();
                ...
                if (codigoPerfume == 91) {
                    ...
                    cliente.setCompra(perfume1,quantidadePerfume);
                    ...
                    cliente.setCompra(perfume2,quantidadePerfume);
                    ...
                    cliente.setCompra(perfume3,quantidadePerfume);
    ...
    public void quemVendeuProduto(RegistroVendedor registroVendedor1){
